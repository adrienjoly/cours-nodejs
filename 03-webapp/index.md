...
9. Pousser vos *commits* dans votre dépôt GitLab.
...
7. Pousser vos *commits* dans votre dépôt GitLab. Puis le mettre le serveur en production sur Heroku.
...
5. Pousser vos modifications dans votre dépôt GitLab.
